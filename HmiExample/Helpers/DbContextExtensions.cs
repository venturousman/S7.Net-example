...
namespace HmiExample.Helpers
{
    public static class DbContextExtensions
    {
        ...
        public static DbContext RefreshAllEntites(this DbContext dbContext, RefreshMode refreshMode = RefreshMode.StoreWins)
        {
            return RefreshEntites(dbContext: dbContext, refreshMode: refreshMode, entityType: null); //null entityType is a wild card
        }

        public static DbContext RefreshEntites<TEntity>(this DbContext dbContext, RefreshMode refreshMode = RefreshMode.StoreWins)
        {
